<?php include 'components/header.php'; ?>
      ...
      <header class="dicas-interna head-interna">
          <div class="nav">
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                  <div class="content">
                     <img src="assets/images/dica.jpg" class="img-interna" alt="Blog - Armas e Bagagens" />

                     <h2>Existe Diferença Entre Pesca e Pescaria?</h2>
                     ...
                     <p>O trecho padrão original de Lorem Ipsum, usado desde o século XVI, está reproduzido abaixo para os interessados. Seções 1.10.32 e 1.10.33 de "de Finibus Bonorum et Malorum" de Cicero também foram reproduzidas abaixo em sua forma exata original, acompanhada das versões para o inglês da tradução feita por H. Rackham em 1914.Planejamento Urbano, Meio Ambiente, Transportes e Habitação e também integra como membro a Comissão de Saúde, Assistência Social e Defesa do Consumidor.editoração eletrônica, permanecendo essencialmente inalterado. Se popularizou</p>
